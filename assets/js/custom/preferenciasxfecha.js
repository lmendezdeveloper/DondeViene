...
function table_body() {
    var count = 0;
    $("#table_body").empty();
    var url = 'https://www.rendicionsostenedor.cl/list_cpreferencias';
    $.getJSON(url, function (result) {
        $.each(result, function (i, o) {
            count++;
            var fil = "<tr>";
            fil += "<th>" + o.fecha.substring(8, 10) + "-" + o.fecha.substring(5, 7) + "-" + o.fecha.substring(0, 4) + "</th>";
            fil += "<td align='right'>0</td>";
            fil += "<td align='right'>0</td>";
            fil += "<td align='right'>0</td>";
            fil += "<td align='right'>0</td>";
            fil += "<td align='right'>0</td>";
            ...
            fil += "<td align='right'>0</td>";
            fil += "<td align='right'>0</td>";
            fil += "<td align='right'>" + o.linea1 + "</td>";
            fil += "<th class='text-right'>" + o.linea1 + "</th>";/*
