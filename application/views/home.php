                ...
                <nav class="teal lighten-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3 m3">
                            <span class="chapter-title">Donde Viene</span>
                        </div>
                    </div>
                </nav>
            </header>
            
            <aside id="slide-out" class="side-nav white fixed" style="width: 250px">
                <div class="side-nav-wrapper">
                    <div class="sidebar-profile">
                        ...
                        <div class="sidebar-profile-info">
                            ...
                            <span>luis.mendez18@inacapmail.cl</spam>
                        </div>
                    </div>
                    <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                        ...
                        <li class="no-padding">
                            <a href="/logout" class="waves-effect waves-grey">
                    ...
                    <div class="footer">
                        <p class="copyright">© 2018 Donde Viene</p>
